...
![Failure domain defined by the limit state function in \autoref{EQ:LimitStateFunction}[^1]. \label{FIG:FailureDomain}](Example.pdf){ width=50% }

[^1]: The figure is created using `Makie.jl` package [@Danisch:2021].
